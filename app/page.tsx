  ...
  return (
    <div className="DuelGambleMainContainer flex min-h-screen bg-white relative overflow-hidden" itemScope itemType="https://schema.org/WebPage">
      <main className="DuelGambleContentWrapper flex flex-col md:flex-row w-full h-screen">
        <section className="DuelGambleLeftSection hidden md:block md:w-1/2 relative" aria-label="Community Highlights">
          <a 
            href="https://discord.gg/Z3ESnvwAK4" 
            target="_blank" 
            rel="noopener noreferrer" 
            className="DuelGambleDiscordLink hidden md:flex absolute top-8 right-8 bg-white rounded-lg px-6 py-2 items-center text-sm z-10 shadow-md border border-gray-300 hover:bg-gray-500/30 hover:text-gray-700 hover:border-gray-500/50 transition-colors duration-300 cursor-pointer animate-float"
          >
        ...
        <section className="DuelGambleRightSection w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center items-center md:items-start relative" aria-label="Join Our Community">
          <a 
            href="https://discord.gg/Z3ESnvwAK4" 
            target="_blank" 
            rel="noopener noreferrer" 
            className="DuelGambleDiscordLink md:hidden absolute top-8 right-8 bg-white rounded-lg px-6 py-2 flex items-center text-sm z-10 shadow-md border border-gray-300 hover:bg-gray-500/30 hover:text-gray-700 hover:border-gray-500/50 transition-colors duration-300 cursor-pointer animate-float"
          >
            discord.gg/DuelGamble 
            <ArrowUpRight className="w-4 h-4 ml-2" aria-hidden="true" />
          </a>
          <div className="w-full max-w-md md:max-w-none mt-16 md:mt-0">
            <h1 className="DuelGambleMainTitle text-3xl sm:text-4xl md:text-5xl font-bold mb-8 text-[#5865F2] text-center md:text-left mx-auto md:mx-0 max-w-3xl px-4 md:px-0 font-sf-pro leading-tight" itemProp="headline">
              You've been invited<br className="hidden sm:inline" /> to Discord!
            </h1>
            <h2 className="DuelGambleSubtitle text-2xl sm:text-3xl md:text-3xl font-semibold mb-4 text-center md:text-left leading-tight">
              Join DuelGamble<br className="hidden sm:inline" /> Community
            </h2>
            <p className="DuelGambleDescription text-gray-600 mb-8 text-center md:text-left mx-auto md:mx-0 max-w-2xl" itemProp="description">
          ...
          <div className="DuelGambleCopyright text-center md:text-left text-sm text-gray-500 mt-4 font-sf-pro w-full">
      ...
      >
        <Draggable 
          ...
          bounds="parent" 
          handle=".drag-handle"
          disabled={isMobile || isAnimating}
        >
          <div 
            ref={nodeRef}
            className={`inline-block overflow-hidden rounded-xl shadow-lg ${
